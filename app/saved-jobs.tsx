  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.backgroundSecondary }]} edges={["top"]}>
      <View style={[styles.header, { backgroundColor: colors.background, borderBottomColor: colors.border }]}>
        ...
        <Text style={[styles.headerTitle, { color: colors.text }]}>Хадгалсан зарууд</Text>
        <View style={{ width: 36 }} />
      </View>
            ...
            return (
              ...
              >
                {img ? (
                  ...
                  <View style={[styles.jobImage, { backgroundColor: colors.backgroundSecondary, alignItems: 'center', justifyContent: 'center' }]}>
                ...
                <TouchableOpacity 
                  ...
                  onPress={(e) => { e.stopPropagation(); toggleSaveJob(job.id); }}
                >
...
const styles = StyleSheet.create({
  container: { flex: 1 },
  header: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 16, paddingVertical: 14, borderWidth: 0, borderBottomWidth: 1 },
